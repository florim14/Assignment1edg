...
public class NotebookDbAdapter {
    ...
    public long updateNote(long IdToUpdate, String newTitle, String newMessage, Note.Category noteCategory){
    ...
    public ArrayList<Note> getAllNotes() {
        ...
        //loop through all of the rows (notes) in our database and create new note objects
        //from those rows and add them to our array list
        ...
        //return the array list now filled with database notes or notes in our database
        return notes;
    }
    ...
    private static class NotebookDbHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w(NotebookDbHelper.class.getName(), "Upgrading database version " + oldVersion +
